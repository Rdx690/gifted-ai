...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~eIpVjLpb#FTLxFEF6a7QDzek0cxeTQS7quL42NTZdvyV6Oa58MjQ", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "916909950582,918258069003", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "918258069003", // Only 1 owner Number Here, others Add to sudo numbers...
...
BOT_NAME: process.env.BOT_NAME || "SOURAJIT-AI", // Input Yours custom...(Maintain font for Flow)
BOT_PIC: process.env.BOT_PIC || "https://files.catbox.moe/y16skc.jpg", // You can Replace with yours...
AUTO_AUDIO: process.env.AUTO_AUDIO || "false",
AUTO_BIO: process.env.AUTO_BIO || "false",
AUTO_BIO_QUOTE: process.env.AUTO_BIO_QUOTE || "SOURAJIT-AI creates things that creates other things",
